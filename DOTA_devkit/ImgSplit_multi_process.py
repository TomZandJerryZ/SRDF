...
if __name__ == '__main__':
    ...
    raw_root_dir = r'C:\Users\60590\Desktop\CAR_'
    split_root_dir = r'C:\Users\60590\Desktop\CAR_S'
    ...
    # 在python3
    # .8
    # 中flask项目运行报错: AttributeError: module
    # 'time'
    # has
    # no
    # attribute
    ...
    # 主要原因是因为python3
    # .8
    # 中不支持clock了, 需要替换成time.pref_counter()
    # 替换就可以了
    # start = time.clock()
