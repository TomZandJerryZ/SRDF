...
class UCASDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        if self.level == 1:
            self.classes = ('__background__',  'car' ,'plane')
    ...
    def _load_image_names(self):
        ...
        with open(image_set_file) as f:
            ...
            image_list = [os.path.join(r'C:\Users\60590\Desktop\CAR_S\images',x.strip()+'.png',) for x in f.readlines()]
